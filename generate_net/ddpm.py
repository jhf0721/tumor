...
class DDPMScheduler(Scheduler):
    ...
    def __init__(
        ...
        schedule: str = "linear_beta",
            #2024.6.27  small___large
        variance_type: str = DDPMVarianceType.FIXED_LARGE,
    ...
    def step(
        ...
        pred_prev_sample = 1 / torch.sqrt(alpha) * (sample - ((1 - alpha) / (torch.sqrt(1 - alpha_prod_t))) * model_output)
        ...
        # pred_prev_sample = (sample - beta ** (0.5) * model_output) / alpha ** (0.5)
