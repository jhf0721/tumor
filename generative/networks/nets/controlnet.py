...
class ControlNet(nn.Module):
    ...
    def __init__(
        ...
        self.time_embed = nn.Sequential(#创建一个时间嵌入模块
    ...
    def forward(
        ...
        # 应用控制网条件嵌入层，这可能是一个自定义层，用于处理条件信息。
        ...
        for down_block_res_sample, controlnet_block in zip(down_block_res_samples, self.controlnet_down_blocks):
            down_block_res_sample = controlnet_block(down_block_res_sample)# 对每个残差样本应用相应的控制网下采样块。
        ...
        mid_block_res_sample *= conditioning_scale#对每个下采样块的残差样本乘以一个缩放因子
